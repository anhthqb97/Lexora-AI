...
**DoD:** [`unit-economics-speaking.md`](../unit-economics-speaking.md) in `docs/product/`.
...
**DoD:** [`staging-environment.md`](../../engineering/staging-environment.md) — Vercel project live; Atlas + Upstash runbooks + Vercel env checklist.
